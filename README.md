...
I learned to use the icons from Font Awesome and copy the svg path to the html code. I also learned to use fill to change the color of the svg.

### Continued development

I need to improve on doing the layout with CSS grid.
